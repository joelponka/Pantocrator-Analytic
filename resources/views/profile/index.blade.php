...
@section('content')
    ...
    <div class="section-body">
        <h2 class="section-title">@lang('Hi'), {{ $user->name }}</h2>
          ...
          <div class="col-12 col-md-12 col-lg-5">
            <div class="card profile-widget">
              <div class="profile-widget-header">                     
                <img alt="image" src="{{ asset('storage/users/images/'. $user->avatar) }}" height="80px" width="80px" class="rounded-circle profile-widget-picture">
              </div>
              <div class="profile-widget-description text-center">
                <div class="profile-widget-name">
                  {{ $user->name }} {{ $user->last_name }} 
                  <div class="text-muted d-inline font-weight-normal"><div class="slash"></div> Web Developer</div></div>
                {{-- Ujang maman is a superhero name in <b>Indonesia</b>, especially in my family. He is not a fictional character but an original hero in my family, a hero for his children and for his wife. So, I use the name as a user in this template. Not a tribute, I'm just bored with <b>'John Doe'</b>. --}}
              </div>
              <div class="card-footer text-center">
                <div class="font-weight-bold mb-2">@lang('Follow') {{ $user->name }} {{ $user->last_name }}</div>
